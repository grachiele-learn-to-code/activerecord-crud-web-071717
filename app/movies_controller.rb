...
def can_find_by_multiple_attributes
  ...
  # release_date == 2000
  # director == "Me"
  Movie.all.find_by(["title = ? and release_date = ? and director = ?", "Title", "2000", "Me"])
end
...
def can_update_using_update_method
  ...
  something = Movie.create(title: "Wat?")
  something.update(title: "Wat, huh?")
  something.save
end
...
def can_destroy_a_single_item
  something = Movie.create(title: "That One Where the Guy Kicks Another Guy Once")
  something.destroy
  something.save
end
